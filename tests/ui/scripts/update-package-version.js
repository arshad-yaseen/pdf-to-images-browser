...
function getLatestVersion() {
  return new Promise((resolve, reject) => {
    const options = {
      ...
      path: '/pdf-to-images-browser/latest',
      method: 'GET',
    };
...
getLatestVersion()
  .then(latestVersion => {
    uiPackageJson.dependencies['pdf-to-images-browser'] = latestVersion;
    ...
    console.log(`Updated pdf-to-images-browser version to ${latestVersion}`);
  })
  .catch(error => {
